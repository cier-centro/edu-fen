    ...
    //$http.get('http://52.37.84.217/edu-unica/service/Resources/Base-jornada-unica.json').success(function(data) {
        ...
        $('#map').vectorMap({
            ...
            onMarkerClick: function(event, index) {
				...
				//content += "<td><a href=\"es/fen2017/" + markers[index].lin + "\">" + markers[index].estado + "</a></td>";
                content += "<td><a>"++"</a>" + markers[index].estado + "</td>";
                content += "</tr>";
